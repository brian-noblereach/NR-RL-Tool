...
The Readiness Level Assessment Tool helps research teams, early-stage ventures, and their advisors measure progress toward commercialization. It provides a structured framework for assessing de-risking milestones across multiple dimensions.
...
- **Multi-Venture Support**: Create, save, and manage multiple assessments
...
└── src/
    ...
    └── data/
        ...
        └── constants.js        # Health term mappings and extras
```
...
3. Data is persisted in browser localStorage
